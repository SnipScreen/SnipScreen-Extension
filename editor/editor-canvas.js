  ...
  */
  export function prepareFinalCanvas() {
    ...
    if (!this.offscreenCanvas || this.offscreenCanvas.width === 0 || this.offscreenCanvas.height === 0) {
        ...
        finalCanvas.width = 1; finalCanvas.height = 1; return finalCanvas;
    }
    ...
    if (this.arrowElements && this.arrowElements.length > 0) {
    ...
    if (this.textElements && this.textElements.length > 0) {
        ...
        this.textElements.forEach(element => {
            ...
            finalCtx.shadowOffsetX = 1; finalCtx.shadowOffsetY = 1; finalCtx.shadowBlur = 2;
            finalCtx.fillText(element.text, element.x, element.y);
            // Reset shadow
            finalCtx.shadowOffsetX = 0; finalCtx.shadowOffsetY = 0; finalCtx.shadowBlur = 0;
        });
    }
